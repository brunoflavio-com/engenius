...
function testPossibleFriends() {
	...
	array(
	  ...
	  array('UserAEmail' => 'test@test.com',
		...
		'Strength' => 5
          ...
          array('UserAEmail' => 'test3@test.com',
		'UserBEmail' => 'test4@test.com',
		'RelationshipTagId' => 1,
		'Strength' => 5
		),
      ),
  ...
  $request2 = new HTTP_Request2('http://localhost:5000/getpossiblefriends?useremail=test@test.com');
  $request2->setMethod(HTTP_Request2::METHOD_GET);
  $request2->setCookieJar($cookieJar);
  $response2 = $request2->send();
  ...
  $expected_friend = 'test4@test.com';
